...
class MapManager {
  ...
  addCoverageSummary(coverage) {
    ...
    const drivenDist = this.ui.constructor.distanceInUserUnits(
  ...
  createBulkActionToolbar() {
    ...
    toolbar.className =
      "bulk-action-toolbar mapboxgl-ctrl mapboxgl-ctrl-group p-2";
