...
(() => {
  ...
  function animateCounter(elementId, endValue, decimals = 0) {
    ...
    const existingCounter = window.InsightsState.getCounter(elementId);
    ...
    if (!existingCounter) {
      ...
      window.InsightsState.setCounter(elementId, counter);
