...
(() => {
  ...
  function initTrendsChart() {
    ...
    window.InsightsState.setChart("trends", chart);
  }
  ...
  function initEfficiencyChart() {
    ...
    window.InsightsState.setChart("efficiency", chart);
  }
  ...
  function initTimeDistChart() {
    ...
    window.InsightsState.setChart("timeDist", chart);
  }
  ...
  function updateTrendsChart() {
    ...
    const chart = window.InsightsState.getChart("trends");
    if (!chart) return;
  ...
  function updateEfficiencyChart() {
    ...
    const chart = window.InsightsState.getChart("efficiency");
    if (!chart) return;
  ...
  function updateTimeDistChart() {
    ...
    const formatHourLabel = window.InsightsFormatters.formatHourLabel;
    ...
    const chart = window.InsightsState.getChart("timeDist");
    if (!chart) return;
  ...
  function handleTimeDistChartClick(_event, activeElements) {
    ...
    window.InsightsModal.loadAndShowTripsForTimePeriod(timeType, timeValue);
  }
