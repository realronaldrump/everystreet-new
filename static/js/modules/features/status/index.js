...
function initialize() {
  ...
  document
    ...
    ?.addEventListener("click", () => loadAll(true), eventOptions);

  document
    .getElementById("quick-refresh-services")
    ?.addEventListener("click", () => loadStatus(true), eventOptions);

  document
    .getElementById("quick-run-all")
    ?.addEventListener("click", () => runAllTasks(), eventOptions);
  ...
  document
    ...
    ?.addEventListener("click", () => loadAppLogs(true), eventOptions);
  document.getElementById("refresh-service-logs")?.addEventListener(
    "click",
    () => {
  ...
  document.getElementById("refresh-container-logs")?.addEventListener(
    "click",
    () => {
  ...
  document.getElementById("service-log-select")?.addEventListener(
    "change",
    (e) => {
  ...
  document.getElementById("container-log-select")?.addEventListener(
    "change",
    (e) => {
  ...
  document
    ...
    ?.addEventListener("click", () => pauseTasks(), eventOptions);
  document
    .getElementById("resumeTasksBtn")
    ?.addEventListener("click", () => resumeTasks(), eventOptions);
  document
    .getElementById("stopAllTasksBtn")
    ?.addEventListener("click", () => stopAllTasks(), eventOptions);
  document
    .getElementById("runAllTasksBtn")
    ?.addEventListener("click", () => runAllTasks(), eventOptions);
  document
    .getElementById("resetTasksBtn")
    ?.addEventListener("click", () => resetTasks(), eventOptions);
  document
    .getElementById("saveTaskConfigBtn")
    ?.addEventListener("click", () => saveTaskConfig(), eventOptions);
  document
    .getElementById("clearHistoryBtn")
    ?.addEventListener("click", () => clearTaskHistory(), eventOptions);

  document.getElementById("globalDisableSwitch")?.addEventListener(
    "change",
    (e) => {
      if (e.target.checked) {
        pauseTasks();
  ...
  document.getElementById("taskConfigTable")?.addEventListener(
    "mousedown",
    (e) => {
...
function updatePlaybooks(data) {
  ...
  container.querySelectorAll("[data-playbook-action]").forEach((btn) => {
    ...
    if (action?.action) {
      btn.addEventListener("click", action.action, eventOptions);
    }
  });
}
