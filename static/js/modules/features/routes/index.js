...
import {
  buildCardInsightSentence,
  buildModalInsightSentence,
  buildRouteActivityTag,
  buildVisitsLink,
...
// Explorer chart instances (destroyed on each explorer render)
...
function renderModalAnalyticsCharts() {
  ...
  renderRouteCharts(analyticsData, routeModalRoute);
}
