...
export function setupManualFetchTripsForm(taskManager, signal) {
...
export function setupGeocodeTrips(signal) {
  const eventOptions = signal ? { signal } : false;
