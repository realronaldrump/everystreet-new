...
(() => {
    ...
    function parseGPX(file, gpxContent) {
      try {
        ...
        const fileEntry = { file, filename: file.name, startTime, endTime, points: coordinates.length, coordinates };
    ...
    function updateStats() {
      ...
      const allTimes = selectedFiles.flatMap(entry => [entry.startTime, entry.endTime]).filter(t => t);
