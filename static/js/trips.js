(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Fetch unique IMEIs on page load
        fetchUniqueImeis();
    });

    function initializeDataTable() {
        const tableElement = $('#trips-table');
        if (!tableElement.length) {
            console.error('Element with ID "trips-table" not found');
            return;
        }

        tripsTable = tableElement.DataTable({
            responsive: true,
            scrollX: true,
            pageLength: 25,
        ...
        console.log('DataTable initialized:', tripsTable);
    }
        ...
        fetch('/api/fetch_trips', {
            ...
            .then(data => {
                if (data.status === 'success') {
                    showModal('Information', data.message);
                    fetchTrips(); 
                } else {
            ...
            .catch(error => {
                ...
                showModal('Error', 'An error occurred while fetching and storing trips.');
            });
    }
    ...
    function exportGPX() {
        ...
        fetch(url)
            ...
            .catch(error => {
                ...
                showModal('Error', error.message || 'An error occurred while exporting GPX.');
            });
    }
