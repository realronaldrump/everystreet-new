    ...
    initializeDrawingMap(manager) {
      ...
      try {
        ...
        if (window.MapboxDraw) {
          ...
          manager.drawingMap.on("draw.create", (e) =>
            Drawing.handleDrawingCreate(manager, e),
          );
          manager.drawingMap.on("draw.update", (e) =>
            Drawing.handleDrawingUpdate(manager, e),
          );
          manager.drawingMap.on("draw.delete", (e) =>
            Drawing.handleDrawingDelete(manager, e),
          );
        } else {
          Drawing.showDrawingError(
            manager,
