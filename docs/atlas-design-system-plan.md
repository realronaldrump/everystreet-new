...
**Status:** Historical implementation record. Superseded 2026-07-09 by the fixed Blueprint & Brass palette, which the motorist's manual design language in [`design-language.md`](design-language.md) has since replaced; the configurable accent and the green-led palette described below have been retired.
