...
async def _render_trips_page(request: Request, trip_id: str | None = None) -> HTMLResponse:
...
async def trips_page(request: Request, highlight: str | None = None, trip_id: str | None = None):
