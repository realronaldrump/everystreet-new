...
CDN = {
    ...
    "three_js": f"https://cdn.jsdelivr.net/npm/three@{LIB_VERSIONS['three']}/build/three.module.js",
    "three_addons": f"https://cdn.jsdelivr.net/npm/three@{LIB_VERSIONS['three']}/examples/jsm/",
