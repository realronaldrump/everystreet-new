...
async def update_background_tasks_config(
    ...
    try:
        ...
        logger.warning(
            "HTTPException in update_background_tasks_config: %s", exc, exc_info=True
        )
        raise
    except Exception as e:
        logger.exception(
...
async def stop_all_background_tasks():
    ...
    try:
        ...
        logger.warning(
            "HTTPException in stop_all_background_tasks: %s", exc, exc_info=True
        )
        raise
    except Exception as e:
...
async def enable_all_background_tasks():
    ...
    try:
        ...
        logger.warning(
            "HTTPException in enable_all_background_tasks: %s", exc, exc_info=True
        )
        raise
    except Exception as e:
...
async def disable_all_background_tasks():
    ...
    try:
        ...
        logger.warning(
            "HTTPException in disable_all_background_tasks: %s", exc, exc_info=True
        )
        raise
    except Exception as e:
