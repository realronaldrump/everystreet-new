...
Provides functions to convert lists of trip dictionaries into standard geospatial
formats (GeoJSON, GPX, and Shapefile) for export and interoperability with other mapping
