...
class RouteResponse:
    ...
    def error(
        ...
        response_status = status_code or STATUS_MAPPINGS.get(error_type, status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                raise HTTPException(
                    status_code=STATUS_MAPPINGS.get(error_type, status.HTTP_500_INTERNAL_SERVER_ERROR),
                    detail=str(e)
                )
