...
class CountyDataService:
    """Service wrapper for county topology data."""
    ...
    async def get_county_topology_document(
        ...
        *,
        ...
        return await get_county_topology_document(
            projection,
    ...
    @staticmethod
    async def refresh_county_topology(projection: str | None = None) -> dict[str, Any]:
        return await refresh_county_topology(projection)


__all__ = [
    "CountyDataService",
    "get_county_topology_document",
    "refresh_county_topology",
]
