...
async def get_vehicles(
    ...
    try:
        ...
        logger.error("Error fetching vehicles: %s", str(e))
...
async def create_vehicle(vehicle_data: VehicleModel) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("Error creating vehicle: %s", str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def update_vehicle(imei: str, vehicle_data: VehicleModel) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("Error updating vehicle: %s", str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def delete_vehicle(imei: str) -> dict[str, str]:
    ...
    try:
        ...
        logger.error("Error deleting vehicle: %s", str(e))
        raise HTTPException(status_code=500, detail=str(e))
