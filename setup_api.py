...
@router.get("/setup/session/{session_id}")
...
@router.post("/setup/session/{session_id}/claim")
...
@router.post("/setup/session/{session_id}/advance")
...
@router.post("/setup/session/{session_id}/step/{step_id}/run")
...
@router.post("/setup/session/{session_id}/cancel")
