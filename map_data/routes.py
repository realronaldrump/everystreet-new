...
async def list_geofabrik_regions(parent: str | None = None) -> dict[str, Any]:
    ...
    Optionally filter by parent region (e.g., "north-america" or "north-america/us").
    Returns regions that can be downloaded for Nominatim and Valhalla.
    """
    try:
...
async def remove_region(region_id: str) -> dict[str, Any]:
    ...
    This removes the PBF file and clears related Nominatim/Valhalla data.
    """
    try:
