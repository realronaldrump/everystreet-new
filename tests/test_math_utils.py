...
def test_circular_average_handles_empty() -> None:
    assert calculate_circular_average_hour([]) is None
...
def test_circular_average_is_unknown_for_opposite_times() -> None:
    assert calculate_circular_average_hour([0.0, 12.0]) is None
