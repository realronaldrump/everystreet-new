...
async def test_performance_monitoring():
    ...
    print(f"✅ Optimization report retrieved - Score: {report['performance_score']}/100")
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Health endpoint: Status = {health_data['status']}, Score = {health_data['performance_score']}")
            else:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Metrics endpoint: {api_requests} API requests in last minute")
            else:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Summary endpoint: {summary_data['time_period_hours']} hour period")
            else:
...
async def main():
    ...
    try:
        ...
        print(f"API Requests (last minute): {updated_metrics['last_minute']['api_requests']}")
        print(f"DB Operations (last minute): {updated_metrics['last_minute']['database_operations']}")
